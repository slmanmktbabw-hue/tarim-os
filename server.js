...
app.post('/api/posts', (req, res) => {
    ...
    savePosts();
    io.emit('broadcast_post', req.body);
    res.json({ ok: true });
});
...
app.post('/api/support', (req, res) => {
    const replies = [
        'تم استلام رسالتك يا ' + req.body.user + ' - سيرد الفريق على slmanmktbabw@gmail.com',
...
server.listen(PORT, () => console.log('🏰 TARIM OS V10.1 WORKING on ' + PORT));

/**
 * TARIM OS - سيرفر المخ السيادي المتكامل (server.js)
...
/* ==========================================================================
   5. توجيه باقي المسارات لملف الواجهة الرئيسي
   ========================================================================== */
app.get('*', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'index.html'));
});

// تشغيل السيرفر المركزي على المنفذ المتاح
const PORT = process.env.PORT || 10000;
server.listen(PORT, '0.0.0.0', () => {
    console.log(`🏰 TARIM OS LIVE on port ${PORT} - KING AL (تريم حضرموت)`);
});
